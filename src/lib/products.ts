...
export const products: Product[] = [
  ...
  },
  {
    ...
    description:
      'Готовый файл-календарь с благоприятными датами на год — методичка, которую получаешь сразу после оплаты. Указаны удачные дни для важных дел в сфере отношений.',
