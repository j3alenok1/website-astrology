...
export const products: Product[] = [
  ...
  },
  {
    ...
    description:
      'Готовая методичка с ответами на вопросы об отношениях: почему тянет к одним типажам, как понять «своего» человека, где искать в натальной карте — плюс календарь благоприятных дат на год. Скачивание сразу после оплаты.',
    format: 'Методичка-календарь с благоприятными датами на год',
    price: '7 777 ₸',
    amountTiyin: 777_700,
  },
  {
