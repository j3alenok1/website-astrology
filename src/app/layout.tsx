...
export const metadata: Metadata = {
  ...
  description:
    'Астролог в Алматы и онлайн для России, Казахстана. Консультации по астрологии и Таро: натальная карта, соляр, совместимость, профориентация. Онлайн и очно.',
  keywords: [
    'астролог алматы',
    'астролог в алматы',
    'астролог',
  ...
  openGraph: {
    title: 'Астролог в Алматы — ASTRO by NDAUZH | Консультации онлайн',
    description:
      'Астролог в Алматы и онлайн для России, Казахстана. Консультации по астрологии и Таро: натальная карта, соляр, совместимость. Онлайн и очно.',
    type: 'website',
    locale: 'ru_RU',
    url: '/',
  ...
  twitter: {
    ...
    description: 'Астролог в Алматы и онлайн для России, Казахстана. Консультации по астрологии и Таро.',
  },
  robots: {
    index: true,
    follow: true,
